...
| Roles | Backend y frontend editorial aceptan `ADMIN` y `EDITORIAL_ADMIN`. | Provisionamiento solo por script controlado; no hay UI global. | EPIC futura de gestion visual, si se necesita. |
