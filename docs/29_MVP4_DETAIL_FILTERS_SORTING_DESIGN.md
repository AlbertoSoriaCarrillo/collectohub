...
44G-C mantiene la ruta existente y anade resumen de filas persistidas, aviso
MISSING legacy, filtros combinables, orden y query params compartibles. Los
resultados filtrados no alteran los contadores completos. El progreso agregado
