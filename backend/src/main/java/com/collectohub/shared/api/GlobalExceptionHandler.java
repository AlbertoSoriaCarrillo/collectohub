...
import com.collectohub.catalog.application.EditorialLegacyBridgeNotFoundException;
...
import com.collectohub.catalog.application.CatalogItemRelationshipNotFoundException;
...
import com.collectohub.inventory.application.ConflictingShopProductReferenceException;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({
            ...
            InvalidCollectionItemFilterException.class,
    ...
    @ExceptionHandler(ConflictingShopProductReferenceException.class)
    ResponseEntity<ErrorResponse> handleShopProductReferenceConflict(
            ConflictingShopProductReferenceException ex,
            HttpServletRequest request
    ) {
        return build(HttpStatus.CONFLICT, ex.getMessage(), request, List.of());
    }
    ...
    @ExceptionHandler({
            ...
            CatalogItemRelationshipNotFoundException.class,
