...
describe('translation dictionaries', () => {
  ...
  it('includes the public editorial catalog vocabulary in both languages', () => {
    ...
    expect(keys).toContain('admin.editorial.relationships.title');
    expect(keys).toContain('admin.editorial.relationships.subtitle');
    expect(keys).toContain('admin.editorial.relationships.sourceItem');
    expect(keys).toContain('admin.editorial.relationships.targetItem');
    expect(keys).toContain('admin.editorial.relationships.selectSourceFirst');
    expect(keys).toContain('admin.editorial.relationships.searchSource');
    expect(keys).toContain('admin.editorial.relationships.searchTarget');
    expect(keys).toContain('admin.editorial.relationships.type');
    expect(keys).toContain('admin.editorial.relationships.order');
    expect(keys).toContain('admin.editorial.relationships.description');
    expect(keys).toContain('admin.editorial.relationships.status');
    expect(keys).toContain('admin.editorial.relationships.create');
    expect(keys).toContain('admin.editorial.relationships.edit');
    expect(keys).toContain('admin.editorial.relationships.delete');
    expect(keys).toContain('admin.editorial.relationships.empty');
    expect(keys).toContain('admin.editorial.relationships.noSource');
    expect(keys).toContain('admin.editorial.relationships.sameItemWarning');
    expect(keys).toContain('admin.editorial.relationships.deleted');
    expect(keys).toContain('admin.editorial.relationships.saved');
    expect(keys).toContain('admin.editorial.relationships.types.ADAPTATION');
    expect(keys).toContain('admin.editorial.relationships.types.REMAKE');
    expect(keys).toContain('admin.editorial.relationships.types.REPRINT');
    expect(keys).toContain('admin.editorial.relationships.types.SAME_WORK');
    expect(keys).toContain('admin.editorial.relationships.types.SPIN_OFF');
    expect(keys).toContain('admin.editorial.relationships.types.PREQUEL');
    expect(keys).toContain('admin.editorial.relationships.types.SEQUEL');
